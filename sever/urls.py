...
from product.views import CategoryProductViewSet, ProductViewSet, SingleProductViewSet
...
urlpatterns = patterns(
    ...
    url(r'^api/v1/', include(accounts_router.urls)), url(r'^api/v1/', include(product_router.urls)),
